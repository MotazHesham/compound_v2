    ...
    <body>
        ...
        <div class="login-root">
            ...
            <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
                ...
                <div class="lang btn" style="z-index: 99999">
                    <i class="fa fa-globe" aria-hidden="true"></i>
                    @if (app()->getLocale() == 'ar')
                        <a href="{{ url()->current() }}?change_language=en" style="color:white">English</a>
                    @else
                        <a href="{{ url()->current() }}?change_language=ar" style="color:white">اللغة العربية</a>
                    @endif
                </div>
                <div class="box-root padding-top--24 flex-flex flex-direction--column"
                    style="flex-grow: 1; z-index: 9;">
                    <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
                        <h1><a href="#" rel="dofollow"><img height="150" src="{{ asset('logo.png') }}" /></a></h1>
                    </div>
                    <div class="formbg-outer">
                        <div class="formbg">
                            <div class="formbg-inner padding-horizontal--48">
                                <span class="padding-bottom--15">{{ trans('auth.sign_to_account') }}</span>
                                @if($errors->count() > 0)
                                ...
                                <form method="POST" action="{{ route('login') }}" id="stripe-login">
                                    ...
                                    <div class="field padding-bottom--24">
                                        <div class="grid--50-50">
                                            <label for="password">{{ trans('auth.password_user') }}</label>
                                    ...
                                    <div class="field padding-bottom--24">
                                        <input type="submit" name="submit" value="{{ trans('auth.continue') }}">
                                    </div>
