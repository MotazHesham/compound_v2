...
{ data: 'problem_photos', name: 'problem_photos', sortable: false, searchable: false },
{ data: 'cancel_reason', name: 'cancel_reason' },
{ data: 'contract_start_date', name: 'contract.start_date' },
{ data: 'client_address', name: 'client.address' },
{ data: 'technician', name: 'technicians.identity_num' },
