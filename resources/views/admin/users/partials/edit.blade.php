<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <select class="form-control select2 {{ $errors->has('nationality') ? 'is-invalid' : '' }}" name="nationality"
            ...
            @foreach (App\Models\User::NATIONALITY_SELECT as $key => $label)
                <option value="{{ $key }}"
                    {{ old('nationality', $user->nationality) === (string) $key ? 'selected' : '' }}>
                    {{ $label }}</option>
            @endforeach
        </select>
    ...
    <div class="form-group col-md-4">
        ...
        <select class="form-control {{ $errors->has('contract_type') ? 'is-invalid' : '' }}" name="contract_type"
            ...
            @foreach (App\Models\User::CONTRACT_TYPE_SELECT as $key => $label)
                <option value="{{ $key }}"
                    {{ old('contract_type', $user->contract_type) === (string) $key ? 'selected' : '' }}>
                    {{ $label }}</option>
            @endforeach
        </select>
    ...
    <div class="col-md-12" id="on_bail" style="display: none">
        <div class="form-group ">
            ...
            <input class="form-control {{ $errors->has('job_num') ? 'is-invalid' : '' }}" type="text" name="job_num"
                id="job_num" value="{{ old('job_num', $user->job_num) }}">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text"
                    name="company_name" id="company_name" value="{{ old('company_name', $user->company_name) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('company_field') ? 'is-invalid' : '' }}" type="text"
                    name="company_field" id="company_field"
                    value="{{ old('company_field', $user->company_field) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('commerical_num') ? 'is-invalid' : '' }}" type="text"
                    name="commerical_num" id="commerical_num"
                    value="{{ old('commerical_num', $user->commerical_num) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('manager_name') ? 'is-invalid' : '' }}" type="text"
                    name="manager_name" id="manager_name" value="{{ old('manager_name', $user->manager_name) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('manager_phone') ? 'is-invalid' : '' }}" type="text"
                    ...
                    value="{{ old('manager_phone', $user->manager_phone) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('manager_email') ? 'is-invalid' : '' }}" type="email"
                    name="manager_email" id="manager_email"
                    value="{{ old('manager_email', $user->manager_email) }}">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control {{ $errors->has('contract_by') ? 'is-invalid' : '' }}"
                    ...
                    @foreach (App\Models\User::CONTRACT_BY_SELECT as $key => $label)
                        <option value="{{ $key }}"
                            {{ old('contract_by', $user->contract_by) === (string) $key ? 'selected' : '' }}>
                            {{ $label }}</option>
                    @endforeach
                </select>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control date {{ $errors->has('contract_start') ? 'is-invalid' : '' }}"
                            type="text" name="contract_start" id="contract_start"
                            value="{{ old('contract_start', $user->contract_start) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control date {{ $errors->has('contract_end') ? 'is-invalid' : '' }}"
                            type="text" name="contract_end" id="contract_end"
                            value="{{ old('contract_end', $user->contract_end) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('commissioner_name') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_name', $user->commissioner_name) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <select
                    class="form-control select2 {{ $errors->has('commissioner_nationality') ? 'is-invalid' : '' }}"
                    ...
                    @foreach (App\Models\User::NATIONALITY_SELECT as $key => $label)
                        <option value="{{ $key }}"
                            {{ old('commissioner_nationality', $user->commissioner_nationality) === (string) $key ? 'selected' : '' }}>
                            {{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('commissioner_id_number') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_id_number', $user->commissioner_id_number) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control date {{ $errors->has('commissioner_id_start') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_id_start', $user->commissioner_id_start) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control date {{ $errors->has('commissioner_id_end') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_id_end', $user->commissioner_id_end) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('commissioner_job') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_job', $user->commissioner_job) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('commissioner_phone') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_phone', $user->commissioner_phone) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('commissioner_email') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('commissioner_email', $user->commissioner_email) }}">
...
@section('scripts')
    <script>
        ...
        function changeContractBy() {
            if ($('#contract_by').val() == 'external') {
                $('#contact_dates').css('display', 'block');
            } else if ($('#contract_by').val() == 'ajir') {
                $('#contact_dates').css('display', 'none');
            }
        }

        function changeContractType() {
            if ($('#contract_type').val() == 'on_bail') {
                $('#on_bail').css('display', 'block');
                $('#subcontractor').css('display', 'none');
            } else if ($('#contract_type').val() == 'subcontractor') {
