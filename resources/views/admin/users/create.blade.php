    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                ...
                <input type="hidden" name="contract_type" value="on_bail">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="job_num" class="required">{{ trans('cruds.user.fields.job_num') }}</label>
                            <input class="form-control {{ $errors->has('job_num') ? 'is-invalid' : '' }}" type="text"
                                name="job_num" id="job_num" value="{{ old('job_num', '') }}" required>
