        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="form-group">
                        <a class="btn btn-default" href="{{ route('tenant.contracts.index') }}">
        ...
        <div class="card">
            ...
            <div class="tab-content">
                <div class="tab-pane active" role="tabpanel" id="contract_appointments">
                    @includeIf('tenant.contracts.relationships.contractAppointments', ['appointments' => $contract->contractAppointments])
                </div>
            </div>
        </div>
