...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("tenant.profile.password.updateProfile") }}">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="required" for="title">{{ trans('cruds.user.fields.username') }}</label>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("tenant.profile.password.update") }}">
                    @csrf
                    <div class="form-group">
